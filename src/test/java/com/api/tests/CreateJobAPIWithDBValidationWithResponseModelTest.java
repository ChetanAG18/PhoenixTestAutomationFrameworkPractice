...
public class CreateJobAPIWithDBValidationWithResponseModelTest {
	...
	public void setUp() {
		...
		customerAddress = new CustomerAddress("D 404", "Vasant Galaxy", "Mangalawar Pet", "Inorbit", "Laxmi Nagar",
				"587311", "India", "Karnataka");
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "78242739906652", "78242739906652",
				"78242739906652", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
	...
	public void createJobAPITest() {
		...
		CreateJobResponseModel createJobResponseModel = jobService.create(FD, createJobPayload)
